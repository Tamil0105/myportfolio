 ...
 const navigate = useNavigate()
  ...
  return (
    ...
    onMouseEnter={() =>setLinkHovered(false)}
      ...
      id={"gozencal"}
      className="bg-gray-50 text-black border-green-600 relative h-full"
    >
      <div
        ref={ref}
      ...
      >
        ...
        >
          ...
          >
            <div className="h-full hidden w-[40%] xl:flex gap-2 justify-center items-center">
              {["DESIGN", "DEVELOPMENT", "MOTION", "STRATEGY"]?.map(
                (item, index) => (
                  <p
                    key={index}
                    className="bg-white text-green-600 shadow-lg rounded-full p-2"
                  >
                    {item}
                  </p>
                )
            ...
            >
              <BsArrowDown className="h-28   font-thin w-16 text-green-600" />
            </motion.div>
            <div className="h-full hidden  w-[40%] text-4xl text-green-600 text-center xl:flex justify-center items-center">
              <span className="w-[90%]">
      ...
      <div className="h-full w-full flex flex-col gap-16  py-16">
        <div className="xl:px-48 px-5  flex flex-col  ">
          <div className="xl:w-[60%] flex flex-col gap-10 w-full">
            <button className="border text-green-600 border-green-600 rounded-full px-4 py-2  w-full xl:w-[30%]">
              DESCRIPTION
            </button>
