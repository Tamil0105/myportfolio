    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <BsArrowDown className="h-28   font-thin w-16 text-blue-600" />
            </motion.div>
            <div className="h-full hidden  w-[40%] text-4xl text-blue-600 text-center xl:flex justify-center items-center">
              <span className="w-[90%]">
      ...
      <div className="h-full w-full flex flex-col gap-16  py-16">
        ...
        <div className="w-full flex items-start justify-start xl:px-36 px-5">
          ...
          onClick={() =>{
            navigate('/projects/rental-management')
          }} className="border border-blue-600 cursor-pointer text-blue-600 rounded-full px-4 py-2  w-[50%] xl:w-[15%]">
            NEXT WORK{" "}
          </button>
        </div>
        <div
         ...
         onMouseEnter={() =>setHovered(true)}
              onMouseLeave={() => setHovered(false)}
          className="xl:px-5 px-5 w-full cursor-pointer  flex-col flex gap-14 justify-center items-center">
          <motion.div
